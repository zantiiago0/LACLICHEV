  ...
  namespace apache {
    namespace lucene {
      namespace search {
        ...
        public:
          enum {
            mid_init$_4721dde2a8e3a809,
            mid_compare_9ebb972a63d3bb3c,
            mid_compareBottom_eb4f2d82869c338b,
            mid_compareTop_eb4f2d82869c338b,
            mid_compareValues_4f6968f9d90c21c7,
            mid_copy_bc518be07064cfee,
            mid_getLeafComparator_5bd5137732740289,
            mid_setBottom_e3e5f5ff373509b3,
            mid_setScorer_3dd90a345c8dd698,
            mid_setTopValue_b520e38da2ff4ef3,
            mid_value_87130c2c580a948b,
            mid_isNull_e0de8605a023eb16,
            mid_getBinaryDocValues_368dadf7b32066ad,
            mid_getDocsWithField_e1c593a35cd840ea,
            max_mid
          };
